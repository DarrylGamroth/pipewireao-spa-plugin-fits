...
int main(int argc, char *argv[])
{
	...
	spa_assert_se(factory != NULL &&
			spa_streq(factory->name, SPA_NAME_API_FLISDK_SOURCE));
	...
	{
		const struct spa_dict_item items[] = {
			SPA_DICT_ITEM_INIT(SPA_KEY_API_FLISDK_CAMERA, "not-present"),
		};
		const struct spa_dict info = SPA_DICT_INIT(items,
				SPA_N_ELEMENTS(items));
	...
	{
		const struct spa_dict_item items[] = {
			SPA_DICT_ITEM_INIT(SPA_KEY_API_FLISDK_CAMERA, ""),
		};
		const struct spa_dict info = SPA_DICT_INIT(items,
				SPA_N_ELEMENTS(items));
	...
	}
	{
		const struct spa_dict_item items[] = {
			SPA_DICT_ITEM_INIT(SPA_KEY_API_FLISDK_CAMERA, "mock"),
			SPA_DICT_ITEM_INIT(SPA_KEY_API_FLISDK_READINESS, "eventfd"),
		};
		const struct spa_dict info = SPA_DICT_INIT(items,
				SPA_N_ELEMENTS(items));
