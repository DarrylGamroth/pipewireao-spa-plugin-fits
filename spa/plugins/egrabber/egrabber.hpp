...
#define SPA_KEY_API_EGRABBER_CLPROTOCOL_LIBRARIES "api.egrabber.clprotocol-libraries"
#define SPA_KEY_API_EGRABBER_CLPROTOCOL_DEVICE "api.egrabber.clprotocol-device"
#define SPA_KEY_API_EGRABBER_CAMERA_SERIAL "api.egrabber.camera-serial"
#define SPA_KEY_API_EGRABBER_GENAPI_RUNTIME "api.egrabber.genapi-runtime"
...
#define SPA_KEY_API_EGRABBER_OUTPUT_MODE "api.egrabber.output-mode"
#define SPA_KEY_API_EGRABBER_ROW_BLOCK_ROWS "api.egrabber.row-block-rows"
#define SPA_KEY_API_EGRABBER_DETECTOR_PROFILE "api.egrabber.detector-profile"
