...
#define SPA_KEY_API_CALCULON_ROW_BLOCK_SCHEMA "api.calculon.row-block-schema"
#define SPA_KEY_API_CALCULON_FRAME_SIZE "api.calculon.frame-size"
#define SPA_KEY_API_CALCULON_FRAME_RATE "api.calculon.frame-rate"
#define SPA_KEY_API_CALCULON_FRAME_SCHEMA "api.calculon.frame-schema"
#define SPA_KEY_API_CALCULON_NDARRAY_PROFILE "api.calculon.ndarray-profile"
#define SPA_KEY_API_CALCULON_NDARRAY_ELEMENT_TYPE \
	"api.calculon.ndarray-element-type"
#define SPA_KEY_API_CALCULON_NDARRAY_LAYOUT "api.calculon.ndarray-layout"
